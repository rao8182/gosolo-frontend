...
export default function Home() {
  return (
    <main className="">
      ...
      {/* Products */}
      <section className="py-16 sm:py-24 bg-black" id="products">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {/* Energy Card */}
            <div className="group relative rounded-2xl sm:rounded-3xl overflow-hidden bg-card-bg border border-card-border hover:border-primary/50 transition-all flex flex-col">
              ...
              <div className="p-4 sm:p-6 md:p-8 relative z-10">
                ...
                <h3 className="font-display font-bold text-2xl sm:text-3xl mt-3 sm:mt-4 text-white">
                  ENERGY
                </h3>
                <p className="text-gray-400 mt-2 text-sm sm:text-base">Sour Apple Flavor</p>
              </div>
              <div className="flex-1 flex items-center justify-center relative z-10 py-6 sm:py-8">
                <div className="w-32 h-32 sm:w-48 sm:h-48 rounded-full bg-linear-to-tr from-orange-400 to-yellow-300 blur-2xl opacity-40 absolute group-hover:scale-125 transition-transform duration-700"></div>
                <img
                  alt="Energy Gummies"
                  className="w-28 h-28 sm:w-40 sm:h-40 object-cover rounded-full shadow-2xl group-hover:-translate-y-4 transition-transform duration-500"
              ...
              <div className="p-4 sm:p-6 relative z-10 border-t border-card-border flex justify-between items-center bg-[#111]">
                <span className="font-display font-bold text-lg sm:text-xl text-white">₹549</span>
                <Link href="/shop" className="bg-white text-black w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:bg-primary transition-colors">
                  <span className="material-icons-round text-base sm:text-lg">add</span>
                </Link>
              </div>
            </div>
            
            {/* Focus Card */}
            <div className="group relative rounded-2xl sm:rounded-3xl overflow-hidden bg-card-bg border border-card-border hover:border-secondary/50 transition-all flex flex-col">
              ...
              <div className="p-4 sm:p-6 md:p-8 relative z-10">
                ...
                <p className="text-gray-400 mt-2 text-sm sm:text-base">Blue Raspberry</p>
              </div>
              <div className="flex-1 flex items-center justify-center relative z-10 py-6 sm:py-8">
                <div className="w-32 h-32 sm:w-48 sm:h-48 rounded-full bg-linear-to-tr from-blue-600 to-cyan-400 blur-2xl opacity-40 absolute group-hover:scale-125 transition-transform duration-700"></div>
                <img
                  alt="Focus Gummies"
                  className="w-28 h-28 sm:w-40 sm:h-40 object-cover rounded-full shadow-2xl group-hover:-translate-y-4 transition-transform duration-500"
              ...
              <div className="p-4 sm:p-6 relative z-10 border-t border-card-border flex justify-between items-center bg-[#111]">
                <span className="font-display font-bold text-lg sm:text-xl text-white">₹599</span>
                <Link href="/shop" className="bg-white text-black w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:bg-secondary transition-colors">
                  <span className="material-icons-round text-base sm:text-lg">add</span>
                </Link>
              </div>
            </div>
            ...
            {/* Recovery Card */}
            <div className="group relative rounded-2xl sm:rounded-3xl overflow-hidden bg-card-bg border border-card-border hover:border-purple-500/50 transition-all flex flex-col sm:col-span-2 md:col-span-1">
              ...
              <div className="p-4 sm:p-6 md:p-8 relative z-10">
                ...
                <p className="text-gray-400 mt-2 text-sm sm:text-base">Berry Blast</p>
              </div>
              <div className="flex-1 flex items-center justify-center relative z-10 py-6 sm:py-8">
                <div className="w-32 h-32 sm:w-48 sm:h-48 rounded-full bg-linear-to-tr from-purple-600 to-pink-400 blur-2xl opacity-40 absolute group-hover:scale-125 transition-transform duration-700"></div>
                <img
                  alt="Recovery Gummies"
                  className="w-28 h-28 sm:w-40 sm:h-40 object-cover rounded-full shadow-2xl group-hover:-translate-y-4 transition-transform duration-500"
              ...
              <div className="p-4 sm:p-6 relative z-10 border-t border-card-border flex justify-between items-center bg-[#111]">
                <span className="font-display font-bold text-lg sm:text-xl text-white">₹699</span>
                <Link href="/shop" className="bg-white text-black w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:bg-purple-500 transition-colors">
                  <span className="material-icons-round text-base sm:text-lg">add</span>
                </Link>
              </div>
            </div>
