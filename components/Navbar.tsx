            ...
            {isAdmin && (
              <div className="border-t border-white/10 pt-2 mt-2">
                ...
                <Link
                  href="/admin/products"
                  onClick={() => setMobileMenuOpen(false)}
                  className={`block py-2 px-4 rounded-lg hover:bg-white/10 transition-colors ${isActive("/admin/products") ? "text-white bg-white/5" : "text-gray-300"}`}
                >
                  Manage Products
                </Link>
                <Link
                  href="/admin/settings"
                  onClick={() => setMobileMenuOpen(false)}
                  className={`block py-2 px-4 rounded-lg hover:bg-white/10 transition-colors ${isActive("/admin/settings") ? "text-white bg-white/5" : "text-gray-300"}`}
                >
                  Admin Settings
                </Link>
              </div>
